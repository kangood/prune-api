...
INSERT INTO `c_menu` (`id`, `name`, `label`, `resource_type`, `tree_grade`, `describe_`, `is_general`, `path`, `component`, `state`, `sort_value`, `icon`, `group_`, `data_scope`, `custom_class`, `is_def`, `parentId`, `mpath`, `readonly_`, `deleted_at`, `created_by`, `created_at`, `updated_by`, `updated_at`) VALUES ('512216970563653', '对象存储', 'sys.menu2.resource.ossc', '20', NULL, NULL, b'0', 'osscs', '/resource/osscs/list.page.tsx', b'1', 1, '', NULL, NULL, NULL, b'0', '512216121036869', '512216121036869.512216970563653.', b'0', NULL, NULL, '2023-12-18 16:56:11', NULL, '2023-12-18 16:56:11');
COMMIT;
